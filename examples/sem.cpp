/// coronet counting_semaphore demo: 10 threads competing for 3 slots
...
counting_semaphore sem{max_sema_threads};
...
public:
    ...
    task<void> initial_delay() const { co_await async::timeout(delay * time_tick); }
